//
//  AG_ClientSummaryChartInformationView.m
...
@interface AG_ClientSummaryChartInformationView ()
...
@implementation AG_ClientSummaryChartInformationView
...
+ (void)initialize
{
	if (self == [AG_ClientSummaryChartInformationView class])
	{
